...
export default function DashboardShow({ title, value, onViewMore }) {
  ...
  async function getProfile() {
    try {
      ...
      let responce = await axios.get('https://actl.co.in/suchit/categoryget');
      let res = await axios.get('https://actl.co.in/suchit/subcategoryget');
      let order = await axios.get('https://actl.co.in/suchit/getOrder');
